...
ggsave(filename = "SEURAT_NA_P09_SPN_UMAP_CELLTYPE_JAN2023.pdf", plot = plotCluUMAP1, width = 8, height = 6, units = "in", dpi = 300)

plotCluUMAP2 <- DimPlot_scCustom(seurat_object = seuObjFilt, group.by = "CellType", pt.size = 0.1, reduction = "umap", label = TRUE, label.size = 2, raster = TRUE, colors_use = c("gold2", "gold4", "blue2", "red3", "green3"))
ggsave(filename = "SEURAT_NA_P09_SPN_UMAP_CELLTYPE_JAN2023_LABELLED.pdf", plot = plotCluUMAP2, width = 10, height = 8, units = "in", dpi = 300)
...
ggsave(filename = "SEURAT_NA_P09_SPN_VIOLINPLOT_CELLTYPE_QC.pdf", plot = vpl3 , width = 6, height = 6, units = "in", dpi = 150, useDingbats=FALSE)
...
write.table(cellsPerCluster, "SEURAT_NA_P09_SPN_CELLS_BY_CELLTYPE_GENOTYPE.txt", row.names = F, col.names = T, quote = F, sep = "\t")
...
p7 <- ggplot(cellsPerCluster2) +
        ...
        NULL
ggsave(filename = "SEURAT_NA_P09_SPN_CELLS_BY_CELLTYPE_GENOTYPE.pdf", plot = p7, width = 6, height = 4.5, units = "in", dpi = 150)




plotCluUMAP1 <- Cluster_Highlight_Plot(seurat_object = seuObjFilt, cluster_name = "C_dSPN", highlight_color = "blue2", background_color = "lightgray")
ggsave(filename = "SEURAT_NA_P09_SPN_UMAP_dSPNs_JAN2023.pdf", plot = plotCluUMAP1, width = 7, height = 6, units = "in", dpi = 300)
