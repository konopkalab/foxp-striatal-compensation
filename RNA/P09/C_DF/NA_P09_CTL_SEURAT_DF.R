...
# p9.ctl.na13 <- Read10X_h5("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P09/01_COUNTS_RAW/NA13_raw_feature_bc_matrix/CellBender_Out_filtered.h5", use.names = TRUE, unique.features = TRUE)
# print(dim(p9.ctl.na13))
# # 53715 13830

# p9.ctl.na14 <- Read10X_h5("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P09/01_COUNTS_RAW/NA14_raw_feature_bc_matrix/CellBender_Out_filtered.h5", use.names = TRUE, unique.features = TRUE)
# print(dim(p9.ctl.na14))
# # 53715 19108

# p9.ctl.na29 <- Read10X_h5("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P09/01_COUNTS_RAW/NA29_raw_feature_bc_matrix/CellBender_Out_filtered.h5", use.names = TRUE, unique.features = TRUE)
# print(dim(p9.ctl.na29))
# # 53715 18835


# ## adding sample & condition info to column names
# colnames(p9.ctl.na13) <- paste("CTL_P09_NA13", colnames(p9.ctl.na13), sep = "_")
# colnames(p9.ctl.na14) <- paste("CTL_P09_NA14", colnames(p9.ctl.na14), sep = "_")
# colnames(p9.ctl.na29) <- paste("CTL_P09_NA29", colnames(p9.ctl.na29), sep = "_")
...
# save(p9.ctl.data, file = "NA_COUNTS_CTL_P9_CB.RData")



rm(list = ls())
load("NA_COUNTS_CTL_P9_CB.RData")

##------------------------------------
## Initialize the Seurat object with the raw (non-normalized data).
seuObj <- CreateSeuratObject(counts = p9.ctl.data, project = "NA_CTL_P9")
print(dim(seuObj)) 
## 21967 51773
...
##------------------------------------
## Save RData
save(seuObj, file = "NA_SEURAT_CTL_P9_CB.RData")
...
load("NA_SEURAT_CTL_P9_CB.RData")
# seuObj
...
save(seuObjDF, selpcs, selpk, nExp_poi.adj, file = "NA_SEURAT_CTL_P9_CB_DF_temp.RData")


seuObjDF <- doubletFinder_v3(seuObjDF, PCs = 1:selpcs, pN = 0.25, pK = selpk, nExp = nExp_poi.adj, reuse.pANN = "pANN_0.25_0.005_3883", sct = FALSE)

table(seuObjDF$GenoAgeSample, seuObjDF$DF.classifications_0.25_0.005_3883)
#                Doublet Singlet
#   CTL_P09_NA13    1216   12614
#   CTL_P09_NA14    1576   17532
#   CTL_P09_NA29    1091   17744

table(seuObjDF$GenoAgeSample, seuObjDF$DF.classifications_0.25_0.005_3618)
#                Doublet Singlet
#   CTL_P09_NA13    1129   12701
#   CTL_P09_NA14    1480   17628
#   CTL_P09_NA29    1009   17826


seuMeta <- as.data.frame(seuObjDF@meta.data)
seuMetaFiltTemp <- seuMeta[seuMeta$DF.classifications_0.25_0.005_3883 == "Singlet",]
seuMetaFilt <- seuMetaFiltTemp[seuMetaFiltTemp$DF.classifications_0.25_0.005_3618 == "Singlet",]
...
##------------------------------------
## Save RData
save(seuObjDF, file = "NA_SEURAT_CTL_P9_CB_DF.RData")
save(seuMeta, seuMetaFilt, file = "NA_SEURAT_CTL_P9_CB_DF_FILT_META.RData")
