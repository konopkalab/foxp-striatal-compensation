...
clusters2keep <- sort(c(5, 6, 7, 9, 10, 25, 26, 31, 38, 46, 52, 57, 58))
...
#     1    10    11     2     3     4     7     9 
# 14920  4735  2022  8704 12437   577  2438   109

print(table(seuObjSel$SeqBatch))
#     1    10     2     3     7 
# 23624  6866 12437   577  2438
...
##-------------------------------------------------------
## SAVE RDATA
save(seuObjSel, file = "SEURAT_NA_P56_INTERGRATION_HARMONY_CORTICAL.RData")
...
mygenes2 <- c("Snap25", "Gad1", "Vip", "Sst", "Pvalb", "Slc17a6", "Slc17a7", "Rorb", "Foxp1", "Foxp2", "Aqp4", "Pdgfra", "Mog", "Itgam", "Flt1", "Bgn")

fpl1 <- FeaturePlot_scCustom(seurat_object = seuObjSel, features = mygenes2, reduction = "umap", pt.size = 0.05, min.cutoff = 0, max.cutoff = 3, order = TRUE, raster = TRUE)
ggsave(filename = "NA_SEURAT_PLOT_FeaturePlot_orderT2.pdf", plot = fpl1, width = 14, height = 24, units = "in", dpi = 150)

fpl2 <- FeaturePlot_scCustom(seurat_object = seuObjSel, features = mygenes2, reduction = "umap", pt.size = 0.05, min.cutoff = 0, max.cutoff = 3, order = FALSE, raster = TRUE)
ggsave(filename = "NA_SEURAT_PLOT_FeaturePlot_orderF2.pdf", plot = fpl2, width = 14, height = 24, units = "in", dpi = 150)
...
# seuObjSel$CellType <- gsub("^9$", "A_PROG", seuObjSel$RNA_snn_res.1.2)
...
# ggsave(filename = "NA_SEURAT_PLOT_ViolinPlot_1.2.pdf", plot = vpl3 , width = 9, height = 5, units = "in", dpi = 150, useDingbats=FALSE)
