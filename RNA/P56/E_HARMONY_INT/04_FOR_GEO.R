...
##-------------------------------------------------------
## Extract meta table
p56meta <- as.data.frame(seuObjFilt@meta.data)

##-------------------------------------------------------
## Extract counts table
p56counts <- GetAssayData(seuObjFilt, slot = "counts")
mygenes <- as.data.frame(row.names(p56counts))
colnames(mygenes) <- "GeneID"
mygenes$GeneName <- mygenes$GeneID
mygenes$Category <- rep("Gene Expression", nrow(mygenes))
mycellbarcodes <- colnames(p56counts)

##-------------------------------------------------------
## Save output
write.table(p56meta, "p56_meta.tsv", col.names = T, sep = '\t', quote = F, row.names = T)
write.table(mygenes, "p56_features.tsv", col.names = F, sep = '\t', quote = F, row.names = F)
write.table(mycellbarcodes, "p56_barcodes.tsv", col.names = F, sep = '\t', quote = F, row.names = F)
writeMM(p56counts, "p56_matrix.mtx")


##-------------------------------------------------------
## MD5 sum
# md5sum p56_barcodes.tsv       0862798e9d2e4aa6792d77c60eac9330
# md5sum p56_features.tsv       6d7d217d64a0e51da89dafc8009747d0
# md5sum p56_matrix.mtx         4a6e4649c9fd9d01d8bd008d61ea0fa4


##-------------------------------------------------------
## Upload to GEO
# /work/Neuroinformatics_Core/akulk1/RESOURCES/TOOLS/ncftp-3.2.6/bin/ncftpput -F -R -z -u geoftp -p "noducAbAdraleef0" ftp-private.ncbi.nlm.nih.gov ./uploads/akulk1@orcid_gDc1qomY/SNRNASEQ/P56 ./p56_barcodes.tsv
# /work/Neuroinformatics_Core/akulk1/RESOURCES/TOOLS/ncftp-3.2.6/bin/ncftpput -F -R -z -u geoftp -p "noducAbAdraleef0" ftp-private.ncbi.nlm.nih.gov ./uploads/akulk1@orcid_gDc1qomY/SNRNASEQ/P56 ./p56_features.tsv
# /work/Neuroinformatics_Core/akulk1/RESOURCES/TOOLS/ncftp-3.2.6/bin/ncftpput -F -R -z -u geoftp -p "noducAbAdraleef0" ftp-private.ncbi.nlm.nih.gov ./uploads/akulk1@orcid_gDc1qomY/SNRNASEQ/P56 ./p56_matrix.mtx
...
# print("p56 CTL")
# load("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P09/19_CTL_woAmbient_woDoublets/NA_SEURAT_CTL_p56.RData")
# # seuObj
# ctl.seuObj <- seuObj
# rm(seuObj)
# dim(ctl.seuObj)
...
# print("p56 P1-CKO")
# load("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P09/19_P1CKO_woAmbient_woDoublets/NA_SEURAT_P1CKO_p56.RData")
# # seuObj
# p1cko.seuObj <- seuObj
# rm(seuObj)
# dim(p1cko.seuObj)
...
# print("p56 P2CKO")
# load("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P09/19_P2CKO_woAmbient_woDoublets/NA_SEURAT_P2CKO_p56.RData")
# # seuObj
# p2cko.seuObj <- seuObj
# rm(seuObj)
# dim(p2cko.seuObj)
...
# print("p56 P1P2CKO")
# load("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P09/19_P1P2CKO_woAmbient_woDoublets/NA_SEURAT_P1P2CKO_p56.RData")
# # seuObj
...
# mygenes <- c("Mki67", "Sox4", "Sox11", "Foxp1", "Foxp2", "Drd", "Drd2", "Tac1", "Penk", "Casz1", "Aqp4", "Olig1", "Cx3cr1", "Flt1", "Slc17a7", "Dlx2", "Npy", "Ascl1", "Sp56", "Ppp1r1b")
...
# mygenes <- c("Mki67", "Sox4", "Sox11", "Foxp1", "Foxp2", "Drd", "Drd2", "Tac1", "Penk", "Casz1", "Aqp4", "Olig1", "Cspg4", "Mag", "Cx3cr1", "Flt1", "Slc17a7", "Chat", "Dlx2", "Npy", "Ascl1", "Sp56", "Ppp1r1b", "Oprm1", "Isl1", "Pdyn", "Lypd1", "Nnat", "Ebf1", "Epha4", "Mef2c")
...
# ## marker genes
# markerGenes <- c("Aqp4", "Olig1", "Cx3cr1", "Flt2", "Slc17a7", "Chat", "Npy", "Sox4", "Mki67", "Ascl1", "Dlx2", "Sox11", "Sp56", "Ppp1r1b", "Drd1", "Drd2", "Tac1", "Penk")
