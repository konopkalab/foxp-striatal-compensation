...
cluMarkers <- read.table("SEURAT_NA_P56_INTERGRATION_HARMONY_CLU_MARKERS.txt", sep = "\t", header = TRUE)
tab <- cluMarkers
...
pdf("NA_ANNOTATION_FisherOutput_Saunders_Enrich.pdf", width=12, height=20, pointsize=12)
par(mar=c(15, 7, 2, 2))
df=-log10(FisherAdj)
