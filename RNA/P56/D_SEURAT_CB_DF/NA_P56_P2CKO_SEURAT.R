...
# load("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P56/11_DOUBLETFINDER_P2CKO/SEURAT_NA_P56_P2CKO_CB_DF.RData")
# # seuObjDF
...
# print(table(seuObjDFCleaned$GenoAgeSample))
# # P2CKO_P56_NA08 P2CKO_P56_NA11 P2CKO_P56_NA12 P2CKO_P56_NA25 P2CKO_P56_NA41
# #          32468           2200            836          14506            638
# # P2CKO_P56_NA44
# #          26848

# ## cells retained
# cells2keep <- row.names(seuObjDFCleaned@meta.data[seuObjDFCleaned@meta.data$DoubletFinder == "Retained",])
...
# p2cko.n41 <- Read10X_h5("/project/Neuroinformatics_Core/Konopka_lab/akulk1/NEW_SEP2022_NK_NA_EO_CO/03_CELLBENDER_NA/NA41_CellBender_Out_filtered.h5", use.names = TRUE, unique.features = TRUE)
# print(dim(p2cko.n41)) # 53715   717

# p2cko.n44 <- Read10X_h5("/project/Neuroinformatics_Core/Konopka_lab/akulk1/NEW_SEP2022_NK_NA_EO_CO/03_CELLBENDER_NA/NA44_CellBender_Out_filtered.h5", use.names = TRUE, unique.features = TRUE)
# print(dim(p2cko.n44)) # 53715 28686
...
# colnames(p2cko.n41) <- paste("P56_P2CKO_NA41", colnames(p2cko.n41), sep = "_")
# colnames(p2cko.n44) <- paste("P56_P2CKO_NA44", colnames(p2cko.n44), sep = "_")
...
# p2cko.n41.temp <- p2cko.n41[row.names(p2cko.n41) %in% ref$GeneSymbol,]
# p2cko.n44.temp <- p2cko.n44[row.names(p2cko.n44) %in% ref$GeneSymbol,]
...
# P56_P2CKO_NA41 <- as.data.frame(as.matrix(p2cko.n41.temp))
# P56_P2CKO_NA44 <- as.data.frame(as.matrix(p2cko.n44.temp))
...
# P56_P2CKO_NA41$Genes <- row.names(P56_P2CKO_NA41)
# P56_P2CKO_NA44$Genes <- row.names(P56_P2CKO_NA44)


# ## combine individual tables into a giant data frame
# # dataCombined <- list("P56_P2CKO_NA08" = P56_P2CKO_NA08, "P56_P2CKO_NA11" = P56_P2CKO_NA11, "P56_P2CKO_NA12" = P56_P2CKO_NA12, "P56_P2CKO_NA25" = P56_P2CKO_NA25, "P56_P2CKO_NA41" = P56_P2CKO_NA41, "P56_P2CKO_NA44" = P56_P2CKO_NA44)
# dataCombined <- list("P56_P2CKO_NA11" = P56_P2CKO_NA11, "P56_P2CKO_NA25" = P56_P2CKO_NA25, "P56_P2CKO_NA41" = P56_P2CKO_NA41, "P56_P2CKO_NA44" = P56_P2CKO_NA44)
...
# p56.p2cko.data <- na.data[,colnames(na.data) %in% cells2keep]
# print(dim(p56.p2cko.data))
# # 21967 


# save(p56.p2cko.data, file = "NA_SEURAT_P2CKO_P56_CB_DF_COUNTS.RData")



##------------------------------------
rm(list = ls())
load("NA_SEURAT_P2CKO_P56_CB_DF_COUNTS.RData")
# p56.p2cko.data

## Initialize the Seurat object with the raw (non-normalized data).
seuObj <- CreateSeuratObject(counts = p56.p2cko.data, project = "NA_P2CKO_P56")
print(dim(seuObj)) ## 21967 77496
...
# seuObj$LibPrep <- gsub("P56_P2CKO_NA08", 3, seuObj$GenoAgeSample)
seuObj$LibPrep <- gsub("P56_P2CKO_NA11", 4, seuObj$GenoAgeSample)
# seuObj$LibPrep <- gsub("P56_P2CKO_NA12", 4, seuObj$LibPrep)
seuObj$LibPrep <- gsub("P56_P2CKO_NA25", 7, seuObj$LibPrep)
seuObj$LibPrep <- gsub("P56_P2CKO_NA41", 9, seuObj$LibPrep)
seuObj$LibPrep <- gsub("P56_P2CKO_NA44", 10, seuObj$LibPrep)

# seuObj$SeqBatch <- gsub("P56_P2CKO_NA08", 2, seuObj$GenoAgeSample)
seuObj$SeqBatch <- gsub("P56_P2CKO_NA11", 3, seuObj$GenoAgeSample)
# seuObj$SeqBatch <- gsub("P56_P2CKO_NA12", 3, seuObj$SeqBatch)
seuObj$SeqBatch <- gsub("P56_P2CKO_NA25", 7, seuObj$SeqBatch)
seuObj$SeqBatch <- gsub("P56_P2CKO_NA41", 10, seuObj$SeqBatch)
seuObj$SeqBatch <- gsub("P56_P2CKO_NA44", 10, seuObj$SeqBatch)

# seuObj$Sex <- gsub("P56_P2CKO_NA08", "M", seuObj$GenoAgeSample)
seuObj$Sex <- gsub("P56_P2CKO_NA11", "M", seuObj$GenoAgeSample)
# seuObj$Sex <- gsub("P56_P2CKO_NA12", "M", seuObj$Sex)
seuObj$Sex <- gsub("P56_P2CKO_NA25", "F", seuObj$Sex)
seuObj$Sex <- gsub("P56_P2CKO_NA41", "M", seuObj$Sex)
seuObj$Sex <- gsub("P56_P2CKO_NA44", "M", seuObj$Sex)
...
save(seuObj, file = "NA_SEURAT_P2CKO_P56_TEMP.RData")


# rm(list = ls())
# load("NA_SEURAT_P2CKO_P56_TEMP.RData")

##------------------------------------
## Harmony
seuObj <- RunHarmony(object = seuObj, group.by.vars = c("LibPrep", "SeqBatch", "Sex"), reduction = "pca", assay.use = "RNA", max.iter.harmony = 100) #, project.dim = FALSE)
...
##------------------------------------
## Save RData
save(seuObj, file = "NA_SEURAT_P2CKO_P56.RData")



# HARMONISED_UMAP <- DimPlot(seuObj, group.by = c("GenoAgeSample", "LibPrep", "SeqBatch", "Sex", "RNA_snn_res.0.8"), pt.size = 0.01, raster = TRUE)
HARMONISED_UMAP <- DimPlot(seuObj, group.by = c("GenoAgeSample", "LibPrep", "SeqBatch", "Sex"), pt.size = 0.01, raster = TRUE)
ggsave("NA_SEURAT_P2CKO_P56_UMAP.pdf", plot = HARMONISED_UMAP, width = 20, height = 12, units = "in", dpi = 300)

HARMONISED_UMAP_FACET <- DimPlot(seuObj, group.by = "GenoAgeSample", pt.size = 0.01, split.by = "GenoAgeSample", ncol = 2, raster = TRUE)
ggsave("NA_SEURAT_P2CKO_P56_UMAP_FACET.pdf", plot = HARMONISED_UMAP_FACET, width = 20, height = 10, units = "in", dpi = 300)
...
# save(seuObj, file = "NA_SEURAT_P2CKO_P1_UPDATED.RData")
...
# load("NA_SEURAT_P2CKO_P1_UPDATED.RData")
# # seuObj

# seuMetaTemp <- as.data.frame(seuObj@meta.data)

# ## Load P1-CTL-01 and P1-CTL-02 from 10X run## load dataset from 10X run
# p1.p2cko.1 <- Read10X(data.dir = "/work/Neuroinformatics_Core/s175848/DATA_BACKUP_AK/NOVASEQ_JUN2021/03_COUNT_WT-WPRE-5/WT03WPRE/outs/filtered_feature_bc_matrix")
# print(dim(p1.p2cko.1)) # 53716 23368

# p1.p2cko.2 <- Read10X(data.dir = "/work/Neuroinformatics_Core/s175848/DATA_BACKUP_AK/NOVASEQ_JUN2021/03_COUNT_WT-WPRE-5/WT04WPRE/outs/filtered_feature_bc_matrix")
# print(dim(p1.p2cko.2)) # 53716 14099

# ## adding sample & condition info to column names
# colnames(p1.p2cko.1) <- paste("CTL_P1_01", colnames(p1.p2cko.1), sep = "_")
# colnames(p1.p2cko.2) <- paste("CTL_P1_02", colnames(p1.p2cko.2), sep = "_")

# p1.ctlw.1 <- as.data.frame(p1.p2cko.1["WPRE",])
# p1.ctlw.2 <- as.data.frame(p1.p2cko.2["WPRE",])
...
# save(seuObj, file = "NA_SEURAT_P2CKO_P1_UPDATED_WPRE_NEW.RData")
...
# # save(seuObj, file = "NA_SEURAT_P2CKO_P1_UPDATED_WPRE.RData")
