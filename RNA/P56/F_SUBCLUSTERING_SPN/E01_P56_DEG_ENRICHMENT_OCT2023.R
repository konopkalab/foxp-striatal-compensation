...
p56_dspn1_list <- filterDEGs("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P56/14_INTEGRATION_wHarmony/SUBCLUSTERING_SPN/SUBCLUSTERING_SPN2/PSEUDOBULK_DGE_CELLTYPE/MASTGLM_ALL_COVARIATES_USE_THIS/SEURAT_NA_DATA_A_dSPN_P1CKO_x_CTL_DEG_TABLE_PSEUDOBULK_FULL.txt", pvalcutoff, l2fccutoff)
p56_dspn2_list <- filterDEGs("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P56/14_INTEGRATION_wHarmony/SUBCLUSTERING_SPN/SUBCLUSTERING_SPN2/PSEUDOBULK_DGE_CELLTYPE/MASTGLM_ALL_COVARIATES_USE_THIS/SEURAT_NA_DATA_A_dSPN_P2CKO_x_CTL_DEG_TABLE_PSEUDOBULK_FULL.txt", pvalcutoff, l2fccutoff)
p56_dspn3_list <- filterDEGs("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/P56/14_INTEGRATION_wHarmony/SUBCLUSTERING_SPN/SUBCLUSTERING_SPN2/PSEUDOBULK_DGE_CELLTYPE/MASTGLM_ALL_COVARIATES_USE_THIS/SEURAT_NA_DATA_A_dSPN_P1P2CKO_x_CTL_DEG_TABLE_PSEUDOBULK_FULL.txt", pvalcutoff, l2fccutoff)


nadspndeg <-list("01_P56_dSPN_P1CKO_X_CTL_UP" = p56_dspn1_list$DOWN, "02_P56_dSPN_P1CKO_X_CTL_DOWN" = p56_dspn1_list$UP,
                 "03_P56_dSPN_P2CKO_X_CTL_UP" = p56_dspn2_list$DOWN, "04_P56_dSPN_P2CKO_X_CTL_DOWN" = p56_dspn2_list$UP,
                 "05_P56_dSPN_P1P2CKO_X_CTL_UP" = p56_dspn3_list$DOWN, "06_P56_dSPN_P1P2CKO_X_CTL_DOWN" = p56_dspn3_list$UP)
...
save(setout, setoutData, setoutAll, file = "OCT2023_NA_P56_ENRICHMENT_DGE_CLASS_SET.RData")
...
write.table(setoutData2, "OCT2023_NA_P56_ENRICHMENT_DGE_CLASS_SET_FOR_PLOT.txt", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
pAll <- pAll + 
        ...
        NULL
ggsave(filename = "OCT2023_NA_P56_ENRICHMENT_DGE_CLASS_SET_FOR_PLOT.pdf", plot = pAll, width = 10, height = 6, units = "in", dpi = 300)


# pdf("NA_P56_ENRICHMENT_DGE_CLASS_SET_FOR_BUBBLE_PLOT.pdf", width = 6, height = 6)
...
pdf("OCT2023_NA_P56_ENRICHMENT_DGE_CLASS_SET_FOR_BUBBLE_PLOT.pdf", width = 8, height = 6)
ggscatter(setoutData3, 
          x = "CELLTYPE_DEG",
          y = "REF_GENES",
          size = "FE",
