...
# colnames(p1cko.na01a) <- paste("P56_P1CKO_NA01A", colnames(p1cko.na01a), sep = "_")
# colnames(p1cko.na01b) <- paste("P56_P1CKO_NA01B", colnames(p1cko.na01b), sep = "_")
...
# dataCombined <- list("P56_P1CKO_NA01_A" = P56_P1CKO_NA01_A, "P56_P1CKO_NA01_B" = P56_P1CKO_NA01_B, "P56_P1CKO_NA06" = P56_P1CKO_NA06, "P56_P1CKO_NA10" = P56_P1CKO_NA10)
...
# print(dim(na.data)) ## 21967 81208

# p56.p1cko.data <- na.data

# save(p56.p1cko.data, file = "NA_P56_P1CKO_CB_COUNTS.RData")

rm(list = ls())
load("NA_P56_P1CKO_CB_COUNTS.RData")

##------------------------------------
## Initialize the Seurat object with the raw (non-normalized data).
seuObj <- CreateSeuratObject(counts = p56.p1cko.data, project = "NA_P56_P1CKO_CB")
print(dim(seuObj)) ## 21967 81208
...
##------------------------------------
## Save RData
save(seuObj, file = "SEURAT_NA_P56_P1CKO_CB.RData")
...
load("SEURAT_NA_P56_P1CKO_CB.RData")
# seuObj
...
save(seuObjDF, file = "SEURAT_NA_P56_P1CKO_CB_DF_TEMP.RData")


seuObjDF <- doubletFinder_v3(seuObjDF, PCs = 1:selpcs, pN = 0.25, pK = selpk, nExp = nExp_poi.adj, reuse.pANN = "pANN_0.25_0.005_8121", sct = FALSE)

table(seuObjDF$GenoAgeSample, seuObjDF$DF.classifications_0.25_0.005_8121)        
#                   Doublet Singlet
#   P1CKO_P56_NA01A    1004   19934
#   P1CKO_P56_NA01B    4297   17885
#   P1CKO_P56_NA06      444   26215
#   P1CKO_P56_NA10     2376    9053

table(seuObjDF$GenoAgeSample, seuObjDF$DF.classifications_0.25_0.005_7836)             
#                   Doublet Singlet
#   P1CKO_P56_NA01A     954   19984
#   P1CKO_P56_NA01B    4152   18030
#   P1CKO_P56_NA06      402   26257
#   P1CKO_P56_NA10     2328    9101


seuMeta <- as.data.frame(seuObjDF@meta.data)
seuMetaFiltTemp <- seuMeta[seuMeta$DF.classifications_0.25_0.005_8121 == "Singlet",]
seuMetaFilt <- seuMetaFiltTemp[seuMetaFiltTemp$DF.classifications_0.25_0.005_7836 == "Singlet",]
...
##------------------------------------
## Save RData
save(seuObjDF, file = "SEURAT_NA_P56_P1CKO_CB_DF.RData")
save(seuMeta, seuMetaFilt, file = "SEURAT_NA_P56_P1CKO_CB_DF_FILT_META.RData")
...
# p1cko.data <- rbind(p1.ctlw.1, p1.ctlw.2)
# p1cko.data$CELLBARCODE <- row.names(p1cko.data)
# common.cb <- intersect(p1cko.data$CELLBARCODE, row.names(seuMetaTemp))
# common.data <- as.data.frame(p1cko.data[p1cko.data$CELLBARCODE %in% common.cb,]) # as.data.frame(p1cko.data[row.names(p1cko.data) %in% common.cb,])
...
# # p1cko.data <- rbind(cb.ctl1, cb.ctl2)
# # common.cb <- intersect(row.names(p1cko.data), row.names(seuMetaTemp))
# # common.data <- p1cko.data[row.names(p1cko.data) %in% common.cb,]
# # common.data$WPRELIB <- rep(1, nrow(common.data))
