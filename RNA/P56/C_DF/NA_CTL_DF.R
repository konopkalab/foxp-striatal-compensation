...
# colnames(ctl.n03a) <- paste("P56_CTL_NA03A", colnames(ctl.n03a), sep = "_")
# colnames(ctl.n03b) <- paste("P56_CTL_NA03B", colnames(ctl.n03b), sep = "_")
# colnames(ctl.n05a) <- paste("P56_CTL_NA05A", colnames(ctl.n05a), sep = "_")
# colnames(ctl.n05b) <- paste("P56_CTL_NA05B", colnames(ctl.n05b), sep = "_")
...
# dataCombined <- list("P56_CTL_NA03_A" = P56_CTL_NA03_A, "P56_CTL_NA03_B" = P56_CTL_NA03_B, "P56_CTL_NA05_A" = P56_CTL_NA05_A, "P56_CTL_NA05_B" = P56_CTL_NA05_B, "P56_CTL_NA07" = P56_CTL_NA07)
...
# print(dim(na.data)) ## 21967 130569

# p56.ctl.data <- na.data

# save(p56.ctl.data, file = "NA_P56_CTL_CB_COUNTS.RData")

# # rm(list = ls())
# # load("NA_P56_CTL_CB_COUNTS.RData")

# ##------------------------------------
# ## Initialize the Seurat object with the raw (non-normalized data).
# seuObj <- CreateSeuratObject(counts = p56.ctl.data, project = "NA_P56_CTL_CB")
# print(dim(seuObj)) ## 21967 130569
...
# ##------------------------------------
# ## Save RData
# save(seuObj, file = "SEURAT_NA_P56_CTL_CB.RData")
...
load("SEURAT_NA_P56_CTL_CB.RData")
# seuObj
...
save(seuObjDF, file = "SEURAT_NA_P56_CTL_CB_DF_TEMP.RData")

seuObjDF <- doubletFinder_v3(seuObjDF, PCs = 1:selpcs, pN = 0.25, pK = selpk, nExp = nExp_poi.adj, reuse.pANN = "pANN_0.25_0.005_13057", sct = FALSE)

table(seuObjDF$GenoAgeSample, seuObjDF$DF.classifications_0.25_0.005_13057)        
#                 Doublet Singlet
#   CTL_P56_NA03A     559   24418
#   CTL_P56_NA03B    4676   23659
#   CTL_P56_NA05A     425   24454
#   CTL_P56_NA05B    3723   22906
#   CTL_P56_NA07     3674   22075

table(seuObjDF$GenoAgeSample, seuObjDF$DF.classifications_0.25_0.005_12334)             
#                 Doublet Singlet
#   CTL_P56_NA03A     508   24469
#   CTL_P56_NA03B    4439   23896
#   CTL_P56_NA05A     378   24501
#   CTL_P56_NA05B    3510   23119
#   CTL_P56_NA07     3499   22250


seuMeta <- as.data.frame(seuObjDF@meta.data)
seuMetaFiltTemp <- seuMeta[seuMeta$DF.classifications_0.25_0.005_13057 == "Singlet",]
seuMetaFilt <- seuMetaFiltTemp[seuMetaFiltTemp$DF.classifications_0.25_0.005_12334 == "Singlet",]
...
##------------------------------------
## Save RData
save(seuObjDF, file = "SEURAT_NA_P56_CTL_CB_DF.RData")
save(seuMeta, seuMetaFilt, file = "SEURAT_NA_P56_CTL_CB_DF_FILT_META.RData")
