...
na106macs2 <- grMACS2("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA106_P2CKO_MACS2/NA106_P2CKO_peaks.xls")
na110macs2 <- grMACS2("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA110_P2CKO_MACS2/NA110_P2CKO_peaks.xls")
na114macs2 <- grMACS2("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA114_P2CKO_MACS2/NA114_P2CKO_peaks.xls")

common.peaks.p2cko <- reduce(x = c(na106macs2, na110macs2, na114macs2))
...
processSignac <- function(crCountsPath, crMetaPath, crFragPath, macs2PeaksPath, archrMetaPath, prefx, covSex, covBatch)
    ...
    MACS2_COUNTS <- FeatureMatrix(fragments = Fragments(CR_SEURAT), features = common.peaks.p2cko, cells = colnames(CR_SEURAT))
    ...
    save(MACS2_PEAKS, CR_CHRASSAY, CR_SEURAT, MACS2_COUNTS, MACS2_CHRASSAY, MACS2_SEURAT, AR_META, common.peaks.p2cko, file = paste(prefx, "MACS2_SIGNAC.RData", sep = "_"))
    }


print("=====> PROCESSING NA106_P2CKO")
# crCountsPath, crMetaPath, crFragPath, macs2PeaksPath, archrMetaPath, prefx, covSex, covBatch
processSignac("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_COMBINED_A_B/NA106_P2CKO/filtered_peak_bc_matrix.h5",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_COMBINED_A_B/NA106_P2CKO/singlecell.csv",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_COMBINED_A_B/NA106_P2CKO/fragments.tsv.gz",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA106_P2CKO_MACS2/NA106_P2CKO_peaks.xls",
...
print("=====> PROCESSING NA110_P2CKO")
processSignac("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_C/NA110_P2CKO/filtered_peak_bc_matrix.h5",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_C/NA110_P2CKO/singlecell.csv",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_C/NA110_P2CKO/fragments.tsv.gz",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA110_P2CKO_MACS2/NA110_P2CKO_peaks.xls",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/02_SEURAT_SIGNAC_DOUBLETS_ARCHR1/NA_ATAC_ARCHR_DOUBLETS_META.RData",
              "NA110_P2CKO",
              "F",
              2)

print("=====> PROCESSING NA114_P2CKO")
processSignac("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_D/NA114_P2CKO_M/filtered_peak_bc_matrix.h5",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_D/NA114_P2CKO_M/singlecell.csv",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_D/NA114_P2CKO_M/fragments.tsv.gz",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA114_P2CKO_MACS2/NA114_P2CKO_peaks.xls",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/02_SEURAT_SIGNAC_DOUBLETS_ARCHR1/NA_ATAC_ARCHR_DOUBLETS_META.RData",
              "NA114_P2CKO",
              "M",
              3)
