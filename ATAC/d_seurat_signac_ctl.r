...
na104macs2 <- grMACS2("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA104_CTL_MACS2/NA104_CTL_peaks.xls")
na108macs2 <- grMACS2("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA108_CTL_MACS2/NA108_CTL_peaks.xls")
na112macs2 <- grMACS2("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA112_CTL_MACS2/NA112_CTL_peaks.xls")

common.peaks.ctl <- reduce(x = c(na104macs2, na108macs2, na112macs2))
...
processSignac <- function(crCountsPath, crMetaPath, crFragPath, macs2PeaksPath, archrMetaPath, prefx, covSex, covBatch)
    ...
    MACS2_COUNTS <- FeatureMatrix(fragments = Fragments(CR_SEURAT), features = common.peaks.ctl, cells = colnames(CR_SEURAT))
    ...
    save(MACS2_PEAKS, CR_CHRASSAY, CR_SEURAT, MACS2_COUNTS, MACS2_CHRASSAY, MACS2_SEURAT, AR_META, common.peaks.ctl, file = paste(prefx, "MACS2_SIGNAC.RData", sep = "_"))
    }


print("=====> PROCESSING NA104_CTL")
# crCountsPath, crMetaPath, crFragPath, macs2PeaksPath, archrMetaPath, prefx, covSex, covBatch
processSignac("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_COMBINED_A_B/NA104_CTL/filtered_peak_bc_matrix.h5",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_COMBINED_A_B/NA104_CTL/singlecell.csv",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_COMBINED_A_B/NA104_CTL/fragments.tsv.gz",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA104_CTL_MACS2/NA104_CTL_peaks.xls",
...
print("=====> PROCESSING NA108_CTL")
processSignac("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_C/NA108_CTL/filtered_peak_bc_matrix.h5",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_C/NA108_CTL/singlecell.csv",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_C/NA108_CTL/fragments.tsv.gz",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA108_CTL_MACS2/NA108_CTL_peaks.xls",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/02_SEURAT_SIGNAC_DOUBLETS_ARCHR1/NA_ATAC_ARCHR_DOUBLETS_META.RData",
              "NA108_CTL",
              "M",
              2)

print("=====> PROCESSING NA112_CTL")
processSignac("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_D/NA112_CTL_F/filtered_peak_bc_matrix.h5",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_D/NA112_CTL_F/singlecell.csv",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_D/NA112_CTL_F/fragments.tsv.gz",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA112_CTL_MACS2/NA112_CTL_peaks.xls",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/02_SEURAT_SIGNAC_DOUBLETS_ARCHR1/NA_ATAC_ARCHR_DOUBLETS_META.RData",
              "NA112_CTL",
              "F",
              3)
