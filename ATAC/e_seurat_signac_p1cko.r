...
na105macs2 <- grMACS2("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA105_P1CKO_MACS2/NA105_P1CKO_peaks.xls")
na109macs2 <- grMACS2("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA109_P1CKO_MACS2/NA109_P1CKO_peaks.xls")
na113macs2 <- grMACS2("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA113_P1CKO_MACS2/NA113_P1CKO_peaks.xls")

common.peaks.p1cko <- reduce(x = c(na105macs2, na109macs2, na113macs2))
...
processSignac <- function(crCountsPath, crMetaPath, crFragPath, macs2PeaksPath, archrMetaPath, prefx, covSex, covBatch)
    ...
    MACS2_COUNTS <- FeatureMatrix(fragments = Fragments(CR_SEURAT), features = common.peaks.p1cko, cells = colnames(CR_SEURAT))
    ...
    save(MACS2_PEAKS, CR_CHRASSAY, CR_SEURAT, MACS2_COUNTS, MACS2_CHRASSAY, MACS2_SEURAT, AR_META, common.peaks.p1cko, file = paste(prefx, "MACS2_SIGNAC.RData", sep = "_"))
    }




print("=====> PROCESSING NA105_P1CKO")
# crCountsPath, crMetaPath, crFragPath, macs2PeaksPath, archrMetaPath, prefx, covSex, covBatch
processSignac("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_COMBINED_A_B/NA105_P1CKO/filtered_peak_bc_matrix.h5",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_COMBINED_A_B/NA105_P1CKO/singlecell.csv",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_COMBINED_A_B/NA105_P1CKO/fragments.tsv.gz",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA105_P1CKO_MACS2/NA105_P1CKO_peaks.xls",
...
print("=====> PROCESSING NA109_P1CKO")
processSignac("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_C/NA109_P1CKO/filtered_peak_bc_matrix.h5",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_C/NA109_P1CKO/singlecell.csv",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_C/NA109_P1CKO/fragments.tsv.gz",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA109_P1CKO_MACS2/NA109_P1CKO_peaks.xls",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/02_SEURAT_SIGNAC_DOUBLETS_ARCHR1/NA_ATAC_ARCHR_DOUBLETS_META.RData",
              "NA109_P1CKO",
              "F",
              2)

print("=====> PROCESSING NA113_P1CKO")
processSignac("/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_D/NA113_P1CKO_M/filtered_peak_bc_matrix.h5",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_D/NA113_P1CKO_M/singlecell.csv",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/00_CELLRANGER_D/NA113_P1CKO_M/fragments.tsv.gz",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/04_MACS2/NA113_P1CKO_MACS2/NA113_P1CKO_peaks.xls",
              "/work/Neuroinformatics_Core/akulk1/CELLRANGER/NA_DATA/ATACSEQ/02_SEURAT_SIGNAC_DOUBLETS_ARCHR1/NA_ATAC_ARCHR_DOUBLETS_META.RData",
              "NA113_P1CKO",
              "M",
              3)
